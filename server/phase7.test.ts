...
class Jobs { async getJobs() { return [job] } async getAssignedJobs() { return [] } async getJob() { return job } async createJob() { createJobCalls += 1; return job } async updateJob() { return job } async transitionJob() { return job } async startJob() { return job } async finishJob() { return job } async confirmJob() { return job } }
