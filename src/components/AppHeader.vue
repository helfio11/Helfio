...
<template>
	<header class="topbar">
		<div class="container topbar-inner">
			...
			<button class="menu-toggle" type="button" :aria-expanded="menuOpen" :aria-label="menuOpen ? t('nav.closeMenu') : t('nav.openMenu')" @click="menuOpen = !menuOpen"><span /><span /><span /></button>
